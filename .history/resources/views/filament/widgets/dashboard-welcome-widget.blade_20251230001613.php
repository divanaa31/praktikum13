    ...
    <div class="bg-gradient-to-br from-pink-50 to-pink-100 rounded-lg shadow-lg p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-pink-600 mt-2">{{ $this->getStats()['total_categories'] }}</p>
    ...
    <div class="bg-gradient-to-br from-pink-50 to-pink-100 rounded-lg shadow-lg p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-pink-600 mt-2">{{ $this->getStats()['total_products'] }}</p>
    ...
    <div class="bg-gradient-to-br from-pink-50 to-pink-100 rounded-lg shadow-lg p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-pink-600 mt-2">{{ $this->getStats()['total_users'] }}</p>
